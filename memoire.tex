...
\MotsClefs      {Algorithmes variationnels quantiques\sep Échantillonnage aléatoire\sep Comptage approximatif\sep Auto-réductibilité\sep Satisfaisabilité\sep Réseaux de tenseurs}
