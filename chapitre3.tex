...
Parmi les algorithmes englobés par les VQA se place le célèbre algorithme quantique d'optimisation approximative (« Quantum Approximate Optimization Algorithm ») (QAOA). Étant l'un des premiers VQA appliqués aux problèmes d'optimisation combinatoire, cet algorithme se prête particulièrement bien à nos demandes. De plus, un grand nombre de travaux ont caractérisé celui-ci en profondeur, facilitant ainsi son application à la question directrice du travail de ce mémoire. Cet algorithme est conséquemment l'objet principal de ce chapitre. 
