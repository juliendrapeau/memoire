...
\begin{maindefinition}{Échantillonneur quasi uniforme pleinement polynomial}{fpaus}
...
\begin{maindefinition}{Schéma d'approximation aléatoire pleinement polynomial}{fpras}
