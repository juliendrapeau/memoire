...
\textcolor{mydarkred}{\textit{Average case hard instances are defined as rando rgular...}}
\textcolor{mydarkred}{\textit{Regular graphs are used because the hard instances can be sampled almost uniformly , eliminating bias in their random seleciton.~\cite{vigerEfficientSimpleGeneration2005}}}
